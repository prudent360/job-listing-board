...
function Divider() {
  return <div className="w-px h-6 mx-1" style={{ backgroundColor: "var(--card-border)" }} />;
}
...
export default function RichTextEditor({ content, onChange, placeholder }: RichTextEditorProps) {
  const editor = useEditor({
    ...
    extensions: [
      ...
      Placeholder.configure({ placeholder: placeholder || "Write your job description..." }),
    ],
    content,
    onUpdate: ({ editor }) => {
    ...
    editorProps: {
      attributes: {
        class: "prose prose-sm max-w-none outline-none min-h-[200px] px-4 py-3",
      },
    },
  });
  ...
  return (
    <div className="rounded-lg border overflow-hidden" style={{ borderColor: "var(--input-border)", backgroundColor: "var(--input-bg)" }}>
      {/* Toolbar */}
      <div
        className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b"
        style={{ borderColor: "var(--input-border)", backgroundColor: "var(--section-bg)" }}
      >
        {/* Text style */}
        <ToolbarButton
        ...
        <ToolbarButton
          ...
          title="Align Left"
        >
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M15 15H3v2h12v-2zm0-8H3v2h12V7zM3 13h18v-2H3v2zm0 8h18v-2H3v2zM3 3v2h18V3H3z"/></svg>
        </ToolbarButton>
        <ToolbarButton
          ...
          title="Align Center"
        >
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M7 15v2h10v-2H7zm-4 6h18v-2H3v2zm0-8h18v-2H3v2zm4-6v2h10V7H7zM3 3v2h18V3H3z"/></svg>
        </ToolbarButton>
        ...
        >
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="11" width="18" height="2" rx="1"/></svg>
        </ToolbarButton>
        ...
        <ToolbarButton
          ...
          title="Undo"
        >
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12.5 8c-2.65 0-5.05.99-6.9 2.6L2 7v9h9l-3.62-3.62c1.39-1.16 3.16-1.88 5.12-1.88 3.54 0 6.55 2.31 7.6 5.5l2.37-.78C21.08 11.03 17.15 8 12.5 8z"/></svg>
        </ToolbarButton>
        <ToolbarButton
          onClick={() => editor.chain().focus().redo().run()}
          title="Redo"
        >
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.4 10.6C16.55 8.99 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22L3.9 16c1.05-3.19 4.05-5.5 7.6-5.5 1.95 0 3.73.72 5.12 1.88L13 16h9V7l-3.6 3.6z"/></svg>
        </ToolbarButton>
      </div>
